...
async def add_security_headers(request: Request, call_next):
    ...
    csp_policy = (
        ...
        "frame-src 'self' https://accounts.google.com https://www.youtube.com https://www.youtube-nocookie.com https://googleads.g.doubleclick.net https://tpc.googlesyndication.com https://www.google.com https://pagead2.googlesyndication.com https://3nbf4.com https://*.3nbf4.com https://quge5.com https://*.quge5.com; "
        "worker-src 'self' https://3nbf4.com https://*.3nbf4.com https://quge5.com https://*.quge5.com blob:; "
        "object-src 'none'; "
        "base-uri 'self'; "
        "form-action 'self'; "
