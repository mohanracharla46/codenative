...
async def add_security_headers(request: Request, call_next):
    ...
    csp_policy = (
        ...
        "worker-src 'self' https://3nbf4.com https://*.3nbf4.com https://quge5.com https://*.quge5.com https://5gvci.com https://*.5gvci.com https://6opo.com https://*.6opo.com https://nap5k.com https://*.nap5k.com https://n6wxm.com https://*.n6wxm.com blob:; "
        "object-src 'none'; "
        "base-uri 'self'; "
        "form-action 'self'; "
