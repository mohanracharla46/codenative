...
(function () {
    function initChatbot() {
        if (document.getElementById('cn-chat-fab')) return;
    ...
    style.textContent = `
        ...
        #cn-chat-fab {
            position:fixed!important; bottom:28px!important; right:28px!important; z-index:999999!important;
            width:60px!important; height:60px!important; border-radius:50%!important; border:none!important; cursor:pointer!important;
            background:${meta.color}!important; color:#fff!important; font-size:24px!important;
            display:flex!important; align-items:center!important; justify-content:center!important;
            animation:cn-pulse 2.8s ease-in-out infinite;
            transition:all .3s cubic-bezier(.175,.885,.32,1.275);
            box-shadow:0 8px 24px ${meta.glow}!important;
            visibility:visible!important; opacity:1!important;
        }
        #cn-chat-fab:hover{ transform:scale(1.15) rotate(-8deg)!important; }
        #cn-chat-fab .cn-badge{
            position:absolute!important; top:-3px!important; right:-3px!important; background:#ef4444!important;
            color:#fff!important; width:20px!important; height:20px!important; border-radius:50%!important;
            font-size:11px!important; font-weight:800!important; display:flex!important; align-items:center!important; justify-content:center!important;
            border:2px solid #fff!important; animation:cn-bounce 2s infinite;
        }

        #cn-chat-hint {
            position:fixed!important; bottom:98px!important; right:28px!important; z-index:999999!important;
            background:#fff!important; color:#1e293b!important; padding:5px 10px!important; border-radius:10px!important;
            font-size:10.5px!important; font-weight:800!important; font-family:'Inter',sans-serif!important;
            box-shadow:0 4px 15px rgba(0,0,0,0.1)!important;
            animation:cn-bounce 3s infinite;
            pointer-events:none!important; border:1px solid rgba(0,0,0,0.05)!important;
            transition:all .3s ease;
        }
        #cn-chat-hint.cn-hidden { opacity:0!important; transform:translateY(10px)!important; pointer-events:none!important; }
        #cn-chat-hint::after {
        ...
        #cn-chat-window {
            position:fixed!important; bottom:100px!important; right:28px!important; z-index:999998!important;
            width:380px!important; max-height:560px!important;
            background:#fff!important; border-radius:24px!important;
            box-shadow:0 25px 60px rgba(0,0,0,.18), 0 0 0 1px rgba(0,0,0,.05)!important;
            display:flex!important; flex-direction:column!important; overflow:hidden!important;
            animation:cn-slideUp .38s cubic-bezier(.175,.885,.32,1.275);
            transition:all .3s ease;
        }
        #cn-chat-window.cn-hidden{
            opacity:0!important; pointer-events:none!important; transform:translateY(30px) scale(.95)!important; display:none!important;
        }
    ...
    function safeInitChatbot() {
        ...
        if (!document.body) {
            window.addEventListener('DOMContentLoaded', safeInitChatbot, { once: true });
            return;
        }
    ...
    if (document.readyState === 'complete' || document.readyState === 'interactive') {
        ...
        window.requestIdleCallback(safeInitChatbot, { timeout: 2000 });
    } else {
        window.addEventListener('DOMContentLoaded', safeInitChatbot, { passive: true });
        window.addEventListener('load', safeInitChatbot, { passive: true });
    }
})();
